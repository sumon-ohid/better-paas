	...
	return []Template{
		...
		},
		{
			...
			Env: []Env{
				...
				{Key: "NEXTAUTH_SECRET", Description: "Secret used to sign sessions and tokens.", Required: true, Secret: true, Generate: true},
				{Key: "NEXTAUTH_URL", Description: "Auto-set from your app URL with /api/v1/auth suffix."},
				{Key: "MEILI_HOST", Description: "Meilisearch URL for full-text search (optional).", Required: false},
				{Key: "MEILI_MASTER_KEY", Description: "Meilisearch master key (optional; must match your Meilisearch instance).", Required: false, Secret: true},
			},
			HealthPath: "/",
		...
		},
		{
			...
			Env: []Env{
				{Key: "APP_NAME", Value: "TryPost", Description: "Application name."},
				{Key: "APP_ENV", Value: "production", Description: "Application environment."},
				{Key: "APP_DEBUG", Value: "false", Description: "Enable debug mode."},
				{Key: "APP_KEY", Description: "Laravel application key.", Required: true, Secret: true, Generate: true},
				{Key: "APP_URL", Description: "Public URL, e.g. https://post.example.com.", Required: false},
				{Key: "SELF_HOSTED", Value: "true", Description: "Enable self-hosted mode (closes public registration)."},
				{Key: "DB_CONNECTION", Value: "pgsql", Description: "Database connection type."},
				{Key: "DB_HOST", Description: "Auto-filled from a managed Postgres add-on."},
				{Key: "DB_PORT", Value: "5432", Description: "Database port."},
				{Key: "DB_DATABASE", Value: "trypost", Description: "Database name."},
				{Key: "DB_USERNAME", Description: "Auto-filled from a managed Postgres add-on."},
				{Key: "DB_PASSWORD", Description: "Auto-filled from a managed Postgres add-on.", Secret: true},
				{Key: "REDIS_HOST", Description: "Auto-filled from a managed Redis add-on."},
				{Key: "REDIS_PORT", Value: "6379", Description: "Redis port."},
				{Key: "REDIS_URL", Description: "Auto-filled from a managed Redis add-on.", Secret: true},
				{Key: "REDIS_USERNAME", Value: "default", Description: "Redis ACL username."},
				{Key: "REDIS_PASSWORD", Description: "Auto-filled from a managed Redis add-on.", Secret: true},
				{Key: "QUEUE_CONNECTION", Value: "redis", Description: "Queue driver."},
				{Key: "CACHE_STORE", Value: "redis", Description: "Cache driver."},
				{Key: "SESSION_DRIVER", Value: "database", Description: "Session driver."},
				{Key: "BROADCAST_CONNECTION", Value: "reverb", Description: "Broadcast driver."},
				{Key: "REVERB_APP_ID", Value: "1001", Description: "Reverb app ID."},
				{Key: "REVERB_APP_KEY", Description: "Reverb app key.", Required: true, Secret: true, Generate: true},
				{Key: "REVERB_APP_SECRET", Description: "Reverb app secret.", Required: true, Secret: true, Generate: true},
				{Key: "REVERB_HOST", Value: "localhost", Description: "Reverb host."},
				{Key: "REVERB_PORT", Value: "8080", Description: "Reverb port."},
				{Key: "REVERB_SCHEME", Value: "http", Description: "Reverb scheme."},
				{Key: "FILESYSTEM_DISK", Value: "public", Description: "Filesystem disk."},
				{Key: "MAIL_MAILER", Value: "log", Description: "Mail driver."},
				{Key: "MAIL_FROM_ADDRESS", Value: "hello@example.com", Description: "Mail from address."},
				{Key: "MAIL_FROM_NAME", Value: "TryPost", Description: "Mail from name."},
			},
			HealthPath: "/up",
