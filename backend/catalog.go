	...
	return []CatalogTemplate{
		...
		},
		{
			...
			Env: []CatalogEnv{
				...
				{Key: "DEFAULT_ADMIN_EMAIL", Value: "admin@example.com", Description: "Initial administrator email address.", Required: true},
				{Key: "DEFAULT_ADMIN_PASSWORD", Description: "Initial administrator password.", Required: true, Secret: true, Generate: true},
				{Key: "DEFAULT_ADMIN_NAME", Value: "Admin", Description: "Initial administrator display name.", Required: true},
				{Key: "DEFAULT_ADMIN_USERNAME", Value: "admin", Description: "Initial administrator username.", Required: true},
			},
			HealthPath: "/",
