...
If you prefer to run the entire control plane as a containerized stack, you can pull the official image and run it via Docker Compose:
...
For this, you will need a `docker-compose.yml` file matching the one provided in the root of the repository, mounting `/var/run/docker.sock` and configuring data volume paths.
