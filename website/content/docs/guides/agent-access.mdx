...
<Callout type="info" title="Fastest path: use the paas CLI">
  Run `paas connect https://your-dashboard-url` on your laptop. Sign in in the
  browser, pick a permission profile, and you're done — no curl, no copying admin
  tokens locally. See the full guide: [PaaS CLI — Connect from Your Machine](/docs/guides/paas-cli).
</Callout>
...
<Cards>
  <Card
    ...
    description="Connect from your laptop with paas connect — browser authorization, no curl."
  />
  <Card
