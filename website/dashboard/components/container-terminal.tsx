...
import { createTerminalWs, createHostTerminalWs } from "@/dashboard/lib/api"
...
const DARK_THEME: ITheme = {
  ...
  cursor: "#6b9fff",
  cursorAccent: "#121214",
  selectionBackground: "rgba(107, 159, 255, 0.35)",
  black: "#1b1b1d",
  white: "#ededed",
...
const LIGHT_THEME: ITheme = {
  ...
  cursor: "#3b6fd9",
  cursorAccent: "#ffffff",
  selectionBackground: "rgba(59, 111, 217, 0.25)",
  black: "#20212b",
  white: "#5c5f6e",
