...
import type { BackupInfo, BackupConfig } from "@/dashboard/lib/types"
...
export default function BackupsPage() {
  ...
  const handleDownload = (name: string) => {
    showToast('Read-only demo', 'Backup downloads are disabled in the interactive demo.', 'destructive')
  }
