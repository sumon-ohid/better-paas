...
import { BreadcrumbLink, BreadcrumbPage } from "@/dashboard/components/ui/breadcrumb"
import {
  BreadcrumbHeaderRow,
...
import { Frame, FrameFooter, FramePanel, FrameTitle, FrameDescription } from "@/dashboard/components/ui/frame"
import { Field, FieldLabel, FieldDescription } from "@/dashboard/components/ui/field"
import {
  Table,
  TableBody,
  TableCell,
...
import { AppDomains } from "@/dashboard/components/app-domains"
import { AppVulnerabilities } from "@/dashboard/components/app-vulnerabilities"
import { SitePreview } from "@/dashboard/components/site-preview"
import { EnvVarsCard } from "@/dashboard/components/env-vars-card"
import { EnvVarsEditModal } from "@/dashboard/components/env-vars-edit-modal"
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
const ContainerTerminal = dynamic(
  () =>
    import("@/dashboard/components/container-terminal").then((m) => m.ContainerTerminal),
  {
    ssr: false,
    loading: () => (
          ...
          <div className="space-y-3">
            ...
            >
              <ProjectBreadcrumb
                ...
                projectCrumb={
                  <BreadcrumbLink
                    render={<AppLink href={`/project/${resolvedProjectId}`} />}
                  >
                    {projectName}
                  </BreadcrumbLink>
                }
