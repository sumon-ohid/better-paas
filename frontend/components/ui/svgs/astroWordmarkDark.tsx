...
const AstroWordmarkDark = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} viewBox="0 -6 381 100">
    <defs>
      <linearGradient
        id="a"
        x1="21"
