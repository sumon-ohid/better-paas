...
export function Input({
  ...
  const inputClassName = cn(
    "flex items-center h-8.5 w-full min-w-0 rounded-[inherit] px-[calc(--spacing(3)-1px)] leading-none outline-none [transition:background-color_5000000s_ease-in-out_0s] placeholder:text-muted-foreground/72 sm:h-7.5",
    size === "sm" &&
      "h-7.5 px-[calc(--spacing(2.5)-1px)] sm:h-6.5",
